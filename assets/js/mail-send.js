...
function sendEmail() {
	...
	if (name == "") { err += "<p>The Name Filed is Blank</p>" }
	if (email == "") { err += "<p>The Email Filed is Blank</p>" }
	if (subject == "") { err += "<p>The Subject Filed is Blank</p>" }
	if (message == "") { err += "<p>The Message Filed is Blank</p>" }
